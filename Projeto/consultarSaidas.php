...
<header>
    <h1>Consultar Saída de Veículos</h1>
</header>

<main>

<div class="login-box">
  <form method="POST" action="consultarSaidas.php">
    <div class="user-box">
    <input type="date" required="required" maxlength="10" name="dt"></p>
    </div>
    <a href="consultarSaidas.php">
      <span></span>
      <span></span>
      <span></span>
      <span></span>
...
if($dt != null){
    ...
    $sql = "SELECT * FROM saidas WHERE dt = '$dt'";
...
if($dt != null){
    ...
    if ($result->num_rows > 0){
        ...
        while( $row = $result->fetch_assoc()){
             ...
             "<br>Hr Entrada: " .$row["hrentrada"]. 
             "<br> Cor: " .$row["cor"]. "<br> Hr Saída: ". $row["hrsaida"].
             "<br> Data: " .$row["dt"]. "</div>";
             }
        }
